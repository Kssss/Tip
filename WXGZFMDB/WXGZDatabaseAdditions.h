...
/** Category of additions for `<WXGZDatabase>` class.
...
@interface WXGZDatabase (WXGZDatabaseAdditions)
...
/** Return `int` value for query
 ...
 @note To use this method from Swift, you must include `WXGZDatabaseAdditionsVariadic.swift` in your project.
 */
...
/** The schema of the database.
 ...
 @return `WXGZResultSet` of schema; `nil` on error.
